...
%prep
%autosetup -p1
# OpenSSL 3: ASN1_OCTET_STRING is incomplete without asn1.h
sed -i '/# include <openssl\/x509v3.h>/a# include <openssl/asn1.h>' include/hostcheck.h
sed -i 's/current_name->d.iPAddress->length/ASN1_STRING_length(current_name->d.iPAddress)/g' lib/iolog/hostcheck.c
...
%make_install LIBTOOL=slibtool install_uid=$(id -u) install_gid=$(id -g) sudoers_uid=$(id -u) sudoers_gid=$(id -g)
